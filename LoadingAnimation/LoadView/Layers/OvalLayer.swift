...
class OvalLayer: CAShapeLayer {
    ...
    var ovalPathSmall: UIBezierPath {
        return UIBezierPath.init(ovalIn: CGRect(x: 50.0, y: 50.0, width: 0.0, height: 0.0))
    }
    
    var ovalPathLarge: UIBezierPath {
        return UIBezierPath.init(ovalIn: CGRect(x: 2.5, y: 17.5, width: 95.0, height: 95.0))
    }
    
    var ovalPathSquishVertical: UIBezierPath {
        return UIBezierPath.init(ovalIn: CGRect(x: 2.5, y: 20.0, width: 95.0, height: 90.0))
    }
    
    var ovalPathSquishHorizontal: UIBezierPath {
        return UIBezierPath.init(ovalIn: CGRect(x: 5.0, y: 20.0, width: 90.0, height: 90.0))
    }
